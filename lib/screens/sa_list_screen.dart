...
// UPDATED: Profile images loaded from SQLite via LocalDatabase.
//          No more SharedPreferences.
// ============================================================
  ...
  void _confirmDeleteSA(Map<String, dynamic> sa) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Delete SA Account',
            style: TextStyle(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text(
              'This will unassign them from all schedules. '
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if ((sa['email'] as String).isNotEmpty)
              _detailRow(Icons.email_outlined, 'Email', sa['email']),
            if ((sa['gmail'] as String).isNotEmpty) ...[
              const SizedBox(height: 10),
              _detailRow(Icons.alternate_email, 'Gmail', sa['gmail']),
            ],
            if ((sa['phone'] as String).isNotEmpty) ...[
              const SizedBox(height: 10),
              _detailRow(Icons.phone_outlined, 'Phone', sa['phone']),
            ],
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Student Assistants',
                style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 17)),
            Text('${_saData.length} registered',
                style: const TextStyle(
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('No Student Assistants yet',
                          style: TextStyle(
                              color: Colors.grey[400],
                              fontSize: 16,
                              fontWeight: FontWeight.w600)),
                      const SizedBox(height: 6),
                      Text('Registered SAs will appear here',
                          style: TextStyle(
